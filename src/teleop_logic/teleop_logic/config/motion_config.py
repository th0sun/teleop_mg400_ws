...
MIN_SEND_INTERVAL_SEC = 0.12           # seconds — minimum time between consecutive commands
                                       # ~8Hz max rate. Prevents DynProx from flooding
                                       # Dobot with JointMovJ calls that interrupt each other.
